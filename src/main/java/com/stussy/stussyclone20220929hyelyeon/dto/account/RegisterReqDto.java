...
public class RegisterReqDto {
    ...
    @Size(min = 1, max =3, message = "이름은 세글자 까지만 입력가능합니다", groups = ValidationGroups.SizeCheckGroup.class)
    @Pattern(regexp = "^[가-힇]*$",
    ...
    @Size(min = 1, max =2, message = "성은 2글자 까지만 입력가능합니다.", groups = ValidationGroups.SizeCheckGroup.class)
    @Pattern(regexp = "^[가-힇]*$",
    ...
    @NotBlank(message = "이메일은 비워 둘 수 없습니다", groups = ValidationGroups.NotBlankGroup.class)//비워둘수 없다
    @Email
